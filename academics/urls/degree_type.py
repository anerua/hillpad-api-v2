...
urlpatterns = [
    ...
    path("submit_draft/<int:pk>", views.SubmitDegreeTypeDraftAPIView.as_view(), name="submit_degree_type_draft"),
    path("publish_draft/<int:pk>", views.PublishDegreeTypeDraftAPIView.as_view(), name="publish_degree_type_draft"),
